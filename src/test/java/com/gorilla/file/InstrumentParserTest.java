...
public class InstrumentParserTest {
    ...
    public void testParseInstrument() throws Exception {
        String instrumentOneStr =    "INSTRUMENT1,07-Mar-1996,2.572";
        String instrumentTwoStr =    "INSTRUMENT2,11-Mar-1997,2.672";
        ...
        assertEquals(LocalDate.of(1996, Month.MARCH, 7), instrumentOne.orElse(null).getDate());
        assertEquals(LocalDate.of(1997, Month.MARCH, 11), instrumentTwo.orElse(null).getDate());
